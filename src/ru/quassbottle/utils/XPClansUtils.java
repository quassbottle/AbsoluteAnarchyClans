...
public class XPClansUtils {
    public static String getFormat(String s) {
        return ChatColor.translateAlternateColorCodes('&', s);
    }

    private static final double GOLDEN_VALUE = 1.618;
    ...
    public static int getExp(int lvl) {
        return (int) Math.pow(lvl, (Math.exp(1) * GOLDEN_VALUE));
    }
    ...
    public static String getCenteredMessage(String message) {
        ...
        if (toSendAfter != null) return toSendAfter;
