...
import ru.quassbottle.events.impl.ClanPlayerDemotedEvent;
...
public class DemoteCommand extends BasicCommand {
    @Override
    ...
    public String getDescription() {
        return "понизить игрока в звании";
    }
    ...
    protected void execute(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length > 0) {
            ...
            EventCaller.call(new ClanPlayerDemotedEvent(c, promoted.getPlayer()));
            c.promotePlayer(promoted, 1);
            return;
